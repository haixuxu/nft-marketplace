const ADDRESS = {
  ...
  CONTRACT_ADDRESS: "0xb9398f21acafe1b1cb5556306cd59bdfcf5df31ca1ac055d926c4805e1aaceaa" as `0x${string}`,
  TICKET_CONTRACT_ADDRESS: "0xdfe9598551b14727a9189627932d2507f0928c418aa6f78758834f4c659cacdf" as `0x${string}`,
};
